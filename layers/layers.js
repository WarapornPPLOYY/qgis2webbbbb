...
var format_pl_tambon_4 = new ol.format.GeoJSON();
var features_pl_tambon_4 = format_pl_tambon_4.readFeatures(json_pl_tambon_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_pl_tambon_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_pl_tambon_4.addFeatures(features_pl_tambon_4);
var lyr_pl_tambon_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_pl_tambon_4, 
                style: style_pl_tambon_4,
                interactive: true,
                title: '<img src="styles/legend/pl_tambon_4.png" /> pl_tambon'
            });
...
lyr_StamenTerrainBackground_0.setVisible(true);lyr_pl_amphoe_1.setVisible(true);lyr_pl_stream_2.setVisible(true);lyr_pl_transportation_3.setVisible(true);lyr_pl_tambon_4.setVisible(true);lyr_pl_village_5.setVisible(true);
var layersList = [lyr_StamenTerrainBackground_0,lyr_pl_amphoe_1,lyr_pl_stream_2,lyr_pl_transportation_3,lyr_pl_tambon_4,lyr_pl_village_5];
...
lyr_pl_tambon_4.set('fieldAliases', {'AREA': 'AREA', 'TAM_CODE': 'TAM_CODE', 'TAM_NAM_T': 'TAM_NAM_T', 'AMP_CODE': 'AMP_CODE', 'AMP_NAM_T': 'AMP_NAM_T', 'AMP_NAM_E': 'AMP_NAM_E', });
...
lyr_pl_stream_2.set('fieldImages', {'LENGTH': '', 'STR_ID': '', 'STR_NAM_T': '', 'STR_NAM_E': '', 'LOCAL_NAM': '', 'STR_TYPE': '', });
lyr_pl_transportation_3.set('fieldImages', {'LENGTH': '', 'TRANS_TYP': '', 'TYP_T': '', 'NAME_T': '', 'NAME_E': '', 'TranNo': '', 'TranTyp_n': '', });
lyr_pl_tambon_4.set('fieldImages', {'AREA': '', 'TAM_CODE': '', 'TAM_NAM_T': '', 'AMP_CODE': '', 'AMP_NAM_T': '', 'AMP_NAM_E': '', });
...
lyr_pl_tambon_4.set('fieldLabels', {'AREA': 'no label', 'TAM_CODE': 'no label', 'TAM_NAM_T': 'no label', 'AMP_CODE': 'no label', 'AMP_NAM_T': 'no label', 'AMP_NAM_E': 'no label', });
